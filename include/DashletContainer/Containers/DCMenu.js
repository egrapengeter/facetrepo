...
content+='<a id="dcmenu_close_link" href="#" onclick="lastLoadedMenu=undefined;DCMenu.closeOverlay(\'\',\''+parentid+'\'); return false;"><i class="icon-remove icon-sm"></i></a></div></div><div class="bd"><div class="dccontent">'+data.html+'</div></div></div>';if(typeof(resetEvalBool)!='undefined'&&resetEvalBool==true){resetEvalBool=false;evalHappened=false;}
...
{content+='<div><div style="float:right"><a id="dcmenu_close_link" href="javascript:DCMenu.closeQView()">';content+='<i class="icon-remove icon-sm"></i>';content+='</a></div></div></div><div class="tr"></div><div class="bd">';}else{content+='<div><a id="dcmenu_close_link" href="javascript:DCMenu.closeQView()">';content+='<i class="icon-remove icon-sm"></i>';content+='</a></div></div><div class="tr"></div><div class="bd">';}
