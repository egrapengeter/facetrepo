...
var acl=res.acl;if(!acl.delete){CAL.get('btn-delete').setAttribute('disabled','disabled');}
...
CAL.editAllRecurrences=function(){var record=CAL.get("record").value;if(CAL.get("repeat_parent_id").value!=""){record=CAL.get("repeat_parent_id").value;CAL.get("repeat_parent_id").value="";}
