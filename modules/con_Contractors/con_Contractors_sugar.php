 ...
 * PLACE ANY CUSTOMIZATIONS IN con_Contractors
 */

require_once 'include/SugarObjects/templates/company/Company.php';

class con_Contractors_sugar extends Company {
    public $new_schema = true;
    public $module_dir = 'con_Contractors';
    public $object_name = 'con_Contractors';
    public $table_name = 'con_contractors';
     ...
     * @deprecated
     */
    public function con_Contractors_sugar(){
        $GLOBALS['log']->deprecated('Calls to con_Contractors::con_Contractors are deprecated.');
        self::__construct();
    }
