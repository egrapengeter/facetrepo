select id, evaluation_rating_c, territorymatch, opportunities.estimated_job_start_c as opp_start, opportunities.estimated_completion_date_c opp_end from ( 
                select 
                  con_contractors.id, 
        ...
        -- subquery A above contains the list of contractor IDs, the strength of their territory match, and rating.
            left join con_contractors_fdest_estimates_1 
              left join opportunities_fdest_estimates_1
                left join opportunities
                  left join opportunities_cstm
                  on opportunities.id = opportunities_cstm.id_c
                on opportunities_fdest_estimates_1.opportunities_fdest_estimates_1opportunities.ida = opportunities.id
              on con_contractors_fdest_estimates_1.con_contractors_fdest_estimates_1fdest_estimates_idb = opportunities_fdest_estimates_1.opportunities_fdest_estimates_1fdest_estimates_idb
            on a.id = con_contractors_fdest_estimates_1.con_contractors_fdest_estimates_1con_contractor_ida
